...
export function connectContext<TContext>(context: React.Context<TContext>): <TProps extends TContextProps, TContextProps>
(Cmp: FC<TProps>, mapContextToProps: (context: TContext) => TContextProps) => FC<Omit<TProps, keyof TContextProps>> {
    return function<TProps extends TContextProps, TContextProps>(Cmp: FC<TProps>, mapContextToProps: (context: TContext) => TContextProps): FC<Omit<TProps, keyof TContextProps>> {
